...
public class SceneManager {
    ...
    /**
     * Switch to a new screen on the given stage.
     * @param stage     the current Stage
     * @param fxmlFile  e.g. "login.fxml", "dashboard.fxml"
     */
    public static void switchTo(Stage stage, String fxmlFile) {
        try {

            // If fxmlFile starts with "/", use it directly. Otherwise, use the default path.
